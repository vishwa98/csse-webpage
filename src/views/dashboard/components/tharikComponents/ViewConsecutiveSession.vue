                ...
                <v-row>
                  ...
                  <v-col cols="12" class="text-center">
                    ...
                    <v-btn
                      ...
                      color="blue"
                      class="mr-0"
                      >Edit Consecutive Sessions</v-btn
                    >

                    <v-btn v-else type="submit" color="success" class="mr-0"
                      >Save consecutive Sessions</v-btn
                    >
                    <v-spacer></v-spacer>
                  </v-col>
                </v-row>
...
export default {
  ...
  methods: {
    ...mapActions([
      "editConsecutiveSessionAction",
      "deleteConsecutiveSessionAction",
    ]),
    getSession() {
      let sessionsArr = this.tharikState.consecutiveSessions.filter(
        (x) => x.sid === this.id
      );
      ...
      if (sessionsArr.length > 0) {
        ...
        this.available = true;
        console.log(this.consecutiveSession);
      }
    },
    addSessions() {
      let i = 0;
