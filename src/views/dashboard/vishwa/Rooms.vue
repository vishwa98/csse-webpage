<template>
  ...
  <v-btn to="/components/allbuildings">View All Buildings</v-btn>
  ...
  <v-dialog v-model="dialog" persistent max-width="800px">
              ...
              <v-container grid-list-md>
                  <v-layout wrap>
                      <v-flex xs12 sm12 md12>
                          <v-text-field label="Name" v-model="postData.name" :rules="inputRules" color="#2C3A47"></v-text-field>
                      </v-flex>
                      <v-flex xs12 sm12 md12>
                         <v-select
                    ...
                    ></v-select>
                      ...
                      <v-flex xs12 sm12 md12>
                          <v-text-field label="Maximum Students" v-model="postData.max" :rules="rules.required" color="#2C3A47"></v-text-field>
                      </v-flex>
                      <v-flex>
                          <v-select
    ...
    <v-card-title>
      ...
      <template v-slot:[`item.actions`]="{item}">
          <router-link class="nav-link" :to="'/roomut/' + item.slug">View unavailable times</router-link>
    ...
    availableBuildinggs() {
	  ...
	  methods: {
		  ...
		  loadRooms: async function(){
			  ...
			  let apiURL = 'http://localhost:8000/api/viewrooms';
      ...
      created() {
          ...
          console.log("Load Buildings for Rooms table");
